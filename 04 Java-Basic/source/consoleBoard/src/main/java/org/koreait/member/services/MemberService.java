...
/**
 * Member services 패키지에서 관리하게 되는 객체에 대한 설정
 */
@Configuration
public class MemberService {
    @Bean
    public MemberMapper memberMapper() {
        return DBConnection.getInstance().getSession().getMapper(MemberMapper.class);
    }
    ...
    public MemberUpdateService updateService() {
        return new MemberUpdateService(updateValidator(), memberMapper());
    }
