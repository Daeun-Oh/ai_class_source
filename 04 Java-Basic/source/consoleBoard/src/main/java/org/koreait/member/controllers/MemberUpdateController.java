...
public class MemberUpdateController extends Controller {
    ...
    public void show() {
        ...
        System.out.println("1. 회원명, 2. 전화번호, 3. 비밀번호");
    }
    ...
    public void process(String command) {
        ...
        form.setEmail(MemberSession.getMember().getEmail());    // 현재 로그인한 회원의 이메일로 고정
        ...
        switch (menu) {
            case 1:
                ...
                break;
            case 2:
                String mobile = inputEach("변경할 전화번호", sc);
