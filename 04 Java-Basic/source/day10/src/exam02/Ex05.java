...
public class Ex05 {
    public static void main(String[] args) {
        ...
        /*List<Book> items3 = items2.get("저자2");  // 저자2의 도서
        items3.forEach(System.out::println);*/

        // 책의 이름만 모아서 ArrayList 객체로 변호나
        ArrayList<String> items4 = items.stream()
                .map(Book::getTitle).collect(toCollection(ArrayList::new));
        items4.forEach(System.out::println);

        // 책의 이름만 모아서 "책1, 책2, ..., 책5"라는 하나의 문자열로 반환
